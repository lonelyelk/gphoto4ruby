...
* First of all you'll need the original gphoto2 C library installed. For
  installation instructions goto http://gphoto.org. On Ubuntu 8.04 it is:

    sudo apt-get install gphoto2
    
* To install GPhoto4Ruby gem type:

    sudo gem install lonelyelk-gphoto4ruby --source http://gems.github.com

* Or you can download it from http://rubyforge.org/projects/gphoto4ruby/
  and install with:

    sudo gem install gphoto4ruby-version.gem
  
* Plug your digital camera through usb, locate example.rb file and run:
